...
public class DglEnterpriseCustomerController extends BaseAPIController {
    ...
    public ResponseEntity<?> createDglCustomer(@RequestBody DglEnterpriseCustomerDTO dglEnterpriseCustomerDTO) throws URISyntaxException {
    ...
    public ResponseEntity<?> updateDglCustomer(@RequestBody DglEnterpriseCustomerDTO dglCustomerDTO) throws URISyntaxException {
    ...
    public List<DglEnterpriseCustomerDTO> getAllDglCustomers(@RequestParam(value = "page_no", required = false) int pageNo,
