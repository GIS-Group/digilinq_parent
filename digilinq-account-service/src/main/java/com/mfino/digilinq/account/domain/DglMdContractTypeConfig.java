 ...
 */
@Entity
@Table(name = "dgl_md_contract_type_config", uniqueConstraints = {
		@UniqueConstraint(columnNames = { "config_title" }) })
...
public class DglMdContractTypeConfig implements Serializable {
	...
	public String toString() {
		return "DglMdContractTypeConfig{" + "id=" + getId() + ", configTitle='" + getConfigTitle() + "'"
